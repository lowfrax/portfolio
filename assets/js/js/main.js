/*Desarrollado por Kevin Rodriguez® 2026*/
/*=============== COPYED ===============*/
function copied(){
    document.execCommand("https://github.com/lowfrax");
    swal("Copiado al portapapeles, gracias por compartirlo!", "https://github.com/lowfrax", "success", {
        button: false,
    });
}
...
/*=============== TYPED ===============*/
 const typed = new Typed(".typed", {
  strings: [
    '<i class="type">Kevin Rodriguez</i>',
    '<i class="type">Programador</i>',
    '<i class="type">Estudiante de Ingeniería en Computación</i>',
    '<i class="type">Desarrollador de Software</i>',
  ],
